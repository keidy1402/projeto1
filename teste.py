    ...
    if objetivo == "Alta produtividade":
        ...
        if perfil == "Alta Performance":
            rotina = [
                ...
                "21:00 — Revisão do dia"
            ]

        elif perfil == "Em Evolução":
            rotina = [
                "07:00 — Acordar",
                "07:30 — Organizar prioridades",
                "08:00–11:00 — Bloco de foco",
                "14:00–17:00 — Tarefas importantes",
            ...
            rotina = [
                "08:00 — Acordar",
                "08:30 — Escolher 3 prioridades",
                "10:00 — Bloco de foco curto",
        ...
        if perfil == "Alta Performance":
            ...
            rotina = [
                "08:00 — Acordar",
                "08:30 — Alongamento",
                "10:00 — Atividade principal",
                "18:00 — Tempo de descanso"
            ]
